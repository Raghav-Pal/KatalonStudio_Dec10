...
WebUI.selectOptionByValue(findTestObject('WEB/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare'), 
    'Hongkong CURA Healthcare Center', true)

WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/input_Apply for hospita'))

WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/input_Medicaid_programs'))

WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/span_Visit Date'))

WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/td_24'))

WebUI.setText(findTestObject('WEB/Page_CURA Healthcare Service/textarea_Comment_comment'), 'test comment')

WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyElementPresent(findTestObject('WEB/Page_CURA Healthcare Service/h2_Appointment Confirmation'), 
    5)
